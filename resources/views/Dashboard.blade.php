...
@section('Pages')
    ...
    @can('doctor')
        ...
        <h5 class="mt-3">Ongoing Appointments</h5>
        <div class="table">
            <table class="table table-striped table-sm align-middle">
                <thead>
                    <tr>
                        ...
                        <th class="text-center" scope="col">Ended</th>
                ...
                <tbody>
                    ...
                    @else
                        <tr>
                            <td class="text-center" colspan="6">You do not have any appointments this week</td>
                        </tr>
                    @endif
                </tbody>
            </table>
        ...
        <div class="table">
            <table class="table table-striped table-sm align-middle">
                ...
                <tbody>
                    ...
                    @else
                        <tr>
                            <td class="text-center" colspan="6">You do not have any appointments at all.</td>
                        </tr>
                    @endif
                </tbody>
            </table>
        ...
        {{-- <div class="table">
            <table class="table table-striped table-sm align-middle">
                ...
                <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <span
                                        ...
                                        {{ $myAppointment->appointment->status == 'pending' ? 'Pending' : 'Completed' }}
                                    </span>
                                </td>
                                <td class="text-end">
                    ...
                    @else
                        <tr>
                            <td class="text-center" colspan="5">There are no appointments for you today.</td>
                        </tr>
                    @endif
                </tbody>
            </table>
